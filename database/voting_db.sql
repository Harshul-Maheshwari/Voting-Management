...
(2, 'Nidhi Singh', 'nsingh', 'user123', 1),
(3, 'Shaifali Khan', 'skhan', 'user123', 2),
(4, 'Siddharth Patni', 'spatni', 'user123', 2);
...
(1, 'Union Election', 'Vote to select candidate for Union Election', 1),
(3, 'State Election', 'Vote to select candidate for State Election', 0);
...
(1, 1, 1, 'maleavatar.jpg', 'Abeer Malhotra'),
(3, 1, 1, 'femaleavatar.jpg', 'Mahira Roy'),
(5, 1, 3, 'maleavatar.jpg', 'Niel Singhania'),
(6, 1, 4, 'maleavatar.jpg', 'Ayush Jain'),
(7, 1, 4, 'maleavatar.jpg', 'Abhinav Mittal'),
(8, 1, 4, 'femaleavatar.jpg', 'Arya Kapoor'),
(9, 1, 4, 'maleavatar.jpg', 'Saral Sacheti'),
(10, 1, 4, 'femaleavatar.jpg', 'Neeti Singh'),
(11, 1, 4, 'maleavatar.jpg', 'Sanket Mehta'),
(12, 1, 3, 'femaleavatar.jpg', 'Amaya Malik');
